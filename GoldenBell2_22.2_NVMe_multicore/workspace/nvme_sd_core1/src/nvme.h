...
#define TOTAL_DATA_BUFFER_SIZE                          0x8000000
#define BYTES_PER_DATA_REGION_OF_SLICE                  (16*1024)
#define AVAILABLE_DATA_BUFFER_ENTRY_COUNT				(TOTAL_DATA_BUFFER_SIZE/BYTES_PER_DATA_REGION_OF_SLICE)

#define NVME_BLOCKS_PER_SLICE		(BYTES_PER_DATA_REGION_OF_SLICE / BYTES_PER_NVME_BLOCK)

#define	BYTES_PER_SD_BLOCK		    (512)               /* 512B */
